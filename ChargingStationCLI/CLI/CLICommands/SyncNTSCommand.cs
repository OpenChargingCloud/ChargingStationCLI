...
namespace cloud.charging.open.ChargingStation.CommandLine
{
    ...
    /// <summary>
    /// Ask this station's time servers what the time is.
    /// </summary>
    /// <remarks>
    /// The same thing the NTS page does with 'Sync now'. Both end in
    /// <see cref="ChargingStation.SyncTimeAsync"/>, which asks the same group
    /// of servers, writes every step into the log and keeps the result as the
    /// last synchronisation the page shows - so the log book reads the same
    ...
    /// two stations disagreeing about what they did.
    ///
                                                  ...
                                                  ICLICommand
    {
        ...
        /// asked is the station's configuration, as it is for the button.
        /// </summary>
